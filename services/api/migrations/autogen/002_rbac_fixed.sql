-- ========================================
-- FINAL RBAC SETUP FOR SUPABASE 
-- Pure SQL with proper conflict handling
-- ========================================
...
CREATE OR REPLACE FUNCTION has_permission(p_user_email TEXT, p_resource TEXT, p_action TEXT)
RETURNS BOOLEAN AS $$
BEGIN
    RETURN EXISTS (
