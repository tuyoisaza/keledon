...
echo "[BOOT] Starting KELEDON single-container runtime v0.0.63"
...
echo ""
echo "[BOOT] AutoBrowse configuration (for local development):"
echo "  - AUTOBROWSE_ENABLED: ${AUTOBROWSE_ENABLED:-false}"
echo "  - AUTOBROWSE_URL: ${AUTOBROWSE_URL:-http://localhost:8765}"
echo "  - AutoBrowse requires local Playwright service running separately"
