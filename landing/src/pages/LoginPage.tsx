...
const BUILD_TIME = '2026-03-16T09:15:00Z';
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2">
            ...
            <span className="font-bold text-2xl tracking-tight text-foreground">Keledon</span>
          </Link>
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 bg-background border border-border hover:bg-muted py-2.5 rounded-lg font-medium text-foreground transition-colors"
          >
