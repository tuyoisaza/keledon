...
exports.genesysAdapter = exports.GenesysAdapter = void 0;
const events_1 = require("events");
class GenesysAdapter extends events_1.EventEmitter {
    constructor(config) {
        super();
        this.config = null;
        this.authToken = null;
     ...
     */
    startMonitoring(pollIntervalMs = 5000) {
...
exports.GenesysAdapter = GenesysAdapter;
exports.genesysAdapter = new GenesysAdapter();
//# sourceMappingURL=genesys-adapter.js.map